...
- For Actor Motions: What are the primary incentives, unique constraints, and core duties of the specified actor?
...
### 5. Key Clash Points
List 3–5 specific places where the debate is most likely to be decided. For each clash, include:
- What each side needs to prove to win the clash.
- The suggested weighing metric to win the issue (e.g., Scope vs. Severity, or why this clash acts as a structural prerequisite to the others).
